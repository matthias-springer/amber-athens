...
args: [],
source: "showDamageArea\x0a\x09^ showDamageArea",
messageSends: [],
referencedClasses: []
}),
smalltalk.AthensGlobalMorphSettings);
...
args: ["aBoolean"],
source: "showDamageArea: aBoolean\x0a\x09showDamageArea := aBoolean.",
messageSends: [],
referencedClasses: []
}),
smalltalk.AthensGlobalMorphSettings);
...
smalltalk.AthensMorph.comment="I am an Athens morph. I can be drawn onto an Athens surface.\x0a\x0aI have a list of submorphs (`#submorphs`) and can be added to another morph (`#addMorph:`).\x0a\x0aI do not have a fixed shape, but I have an outer shape that is used for mouse events and focus, and for clipping my submorphs.\x0a\x0a## API\x0a\x0aThe method `#color:` is used to set my color in case the default drawing routine was not overridden. \x0a\x0aThe method `#owner` returns my owner and `#submorphs` return my submorphs. \x0a\x0aThe method `#zIndex:` sets my z-index that is used to determine the drawing order of my owner's submorphs.\x0a\x0a## Drawing\x0a\x0aThe method `#drawOn:` is used for drawing myself using an Athens canvas.\x0a\x0aThe method `#redraw:` schedules a redraw of myself and all of my morphs. When the scheduler decides to redraw me, the method `#redrawNow:on:` is called.\x0a\x0a## Events\x0a\x0aAll methods starting with `on` are used to bind event handlers. An event handler is a block closure that takes an event argument containing specific information about the event.\x0a\x0a`#onKeyDown:` is triggered when a key is pressed down.\x0a\x0a`#onKeyUp:` is triggered when a key is released.\x0a\x0a`#onKeyPress:` is triggered when a key is pressed and provides a case-sensitive ASCII character code. Is not triggered on special keys such as backspace, delete and arrow keys.\x0a\x0a`#onMouseClick:` is triggered when I or one of my submorphs is clicked.\x0a\x0a`#onMouseDown:` is triggered when the mouse button is pressed down while I or one of my submorphs has mouse focus.\x0a\x0a`#onMouseUp:` is triggered when the mouse is released while I or one of my submorphs has mouse focus.\x0a\x0a`#onMouseEnter:` is triggered when I receive mouse focus.\x0a\x0a`#onMouseLeave:` is triggered when I loose mouse focus. Mouse focus is not lost when one of my submorphs receives mouse focus.\x0a\x0a`#onMouseWheel:` is triggered when the mouse scroll wheel is used while I or one of my submorphs has mouse focus.\x0a\x0a## Geometry\x0a\x0aThe method `#translateBy:` is used to change my position. \x0a\x0aThe method `#scaleBy:` is used to scale myself. Non-uniform scaling is supported.\x0a\x0aThe methods `#rotateByDegrees:` and `#rotateByRadians:` are used to rotate myself.\x0a\x0aMy position, rotation and scaling cannot be determined. Instead, these transformations are stored internally in a transformation matrix and subsequent transformations stack.\x0a\x0aThe method `#resetTransformation` resets all my transformations. This method can be used to position myself at given coordinates by first resetting my transformation and translating myself afterwards.\x0a\x0a## Usage example:\x0a\x0a    aMorph \x0a        resetTransformation;\x0a        rotateByDegrees: 45;\x0a        scaleBy: 1.5 @ 2;\x0a        addMorph: AthensMorph new.\x0a";
smalltalk.addMethod(
smalltalk.method({
selector: "addMorph:",
...
args: [],
source: "redraw\x0a\x09< self._world()._redraw_(self['@outerPolygon']._deepCopy()._multiplyBy_(self['@globalPathTransform'])._boundingBox()); \x0a\x09//._deepCopy()._multiplyBy_(self['@globalPathTransform'])._boundingBox(); >",
messageSends: [],
referencedClasses: []
}),
smalltalk.AthensMorph);
...
args: [],
source: "resetTransformation\x0a\x09< self['@transformation']._loadIdentity();\x0a\x09self['@owner']._redraw(); >",
messageSends: [],
referencedClasses: []
}),
smalltalk.AthensMorph);
...
args: ["aNumber"],
source: "rotateBy: aNumber\x0a\x09< self['@transformation']._rotateByRadians_(aNumber);\x0a\x09self['@owner']._redraw(); >",
messageSends: [],
referencedClasses: []
}),
smalltalk.AthensMorph);
...
args: ["aNumber"],
source: "rotateByDegrees: aNumber\x0a\x09< self['@transformation']._rotateByDegrees_(aNumber); \x0a\x09self['@owner']._redraw(); >",
messageSends: [],
referencedClasses: []
}),
smalltalk.AthensMorph);
...
args: ["aNumber"],
source: "rotateByRadians: aNumber\x0a\x09< self['@transformation']._rotateByRadians_(aNumber);\x0a\x09self['@owner']._redraw(); >",
messageSends: [],
referencedClasses: []
}),
smalltalk.AthensMorph);
...
args: ["aPoint"],
source: "scaleBy: aPoint\x0a\x09< self['@transformation']._scaleX_Y_(aPoint['@x'], aPoint['@y']);\x0a\x09self['@owner']._redraw(); >",
messageSends: [],
referencedClasses: []
}),
smalltalk.AthensMorph);
...
args: ["x", "y"],
source: "scaleByX: x Y: y\x0a\x09< self['@transformation']._scaleX_Y_(x, y);\x0a\x09self['@owner']._redraw(); >",
messageSends: [],
referencedClasses: []
}),
smalltalk.AthensMorph);
...
args: ["aPoint"],
source: "translateBy: aPoint\x0a\x09< self['@transformation']._translateX_Y_(aPoint['@x'], aPoint['@y']);\x0a\x09self['@owner']._redraw(); >",
messageSends: [],
referencedClasses: []
}),
smalltalk.AthensMorph);
...
args: ["x", "y"],
source: "translateByX: x Y: y\x0a\x09< self['@transformation']._translateX_Y_(x, y);\x0a\x09self['@owner']._redraw(); >",
messageSends: [],
referencedClasses: []
}),
smalltalk.AthensMorph);
...
args: ["aColor"],
source: "borderColor: aColor\x0a\x09< self['@borderColor'] = aColor;\x0a\x09self._redraw(); >",
messageSends: [],
referencedClasses: []
}),
...
args: ["aColor"],
source: "fillColor: aColor\x0a\x09< self['@fillColor'] = aColor;\x0a\x09self._redraw(); >",
messageSends: [],
referencedClasses: []
}),
smalltalk.AthensRectangleMorph);
...
args: ["aBoolean"],
source: "hasSharpBorder: aBoolean\x0a\x09< self['@hasSharpBorder'] = aBoolean;\x0a\x09self._redraw(); >",
messageSends: [],
referencedClasses: []
}),
smalltalk.AthensRectangleMorph);
...
args: ["aNumber"],
source: "height: aNumber\x0a\x09< self['@height'] = aNumber;\x0a\x09self._layoutChanged();\x0a\x09self._outerShapeChanged();\x0a\x09self._redraw(); >",
messageSends: [],
referencedClasses: []
}),
smalltalk.AthensRectangleMorph);
...
args: [],
source: "initialize\x0a\x09super initialize.\x0a\x09width := height := 50.\x0a\x09borderColor := Color black.\x0a\x09fillColor := Color white.\x0a\x09mouseDownBorderColor := mouseFocusBorderColor := mouseDownFillColor := mouseFocusFillColor := nil.\x0a\x09hasSharpBorder := false.\x0a\x09self outerShapeChanged.\x0a\x09self redraw.",
...
args: [],
source: "outerShapeChanged\x0a\x09< var zero = 0, one = 1, width = self._width();\x0a\x09var innerWidth = width - 1;\x0a\x09self['@shapeOuter'] = zero.__at(zero)._corner_(width.__at(self['@height']));\x0a\x09self['@shapeInner'] = one.__at(one)._corner_(innerWidth.__at(self['@height'] - 1));\x0a\x09self._outerShape_(self['@shapeOuter']); >",
messageSends: [],
referencedClasses: []
}),
smalltalk.AthensRectangleMorph);
...
args: ["aNumber"],
source: "width: aNumber\x0a\x09< self['@width'] = aNumber;\x0a\x09self._layoutChanged();\x0a\x09self._outerShapeChanged();\x0a\x09self._redraw(); >",
messageSends: [],
referencedClasses: []
}),
smalltalk.AthensRectangleMorph);
...
args: [],
source: "initializeColors\x0a\x09fillColor := Color cosmoBlue.\x0a\x09mouseFocusFillColor := Color cosmoMiddleBlue.\x0a\x09borderColor := mouseDownFillColor := mouseDownBorderColor := mouseFocusBorderColor := Color cosmoDarkBlue.\x0a\x09textMorph fontColor: Color white.",
...
args: [],
source: "initialize\x0a\x09worldState := WorldState for: self.\x0a\x09AthensGlobalMorphSettings instance.\x09\x22ensure that singleton exists\x22\x0a\x09super initialize.\x0a\x09self initializeHalos.\x0a\x09morphsUnderHand := {self}.\x0a\x09handPosition := 0@0.\x0a\x09self initializeCallbacks.",
messageSends: ["for:", "instance", "initialize", "initializeHalos", "@", "initializeCallbacks"],
referencedClasses: ["WorldState", "AthensGlobalMorphSettings"]
}),
smalltalk.AthensWorldMorph);
...
args: ["aRect"],
source: "redraw: aRect\x0a\x09worldState damageArea: aRect.",
...
args: ["aRect"],
source: "damageArea: aRect\x0a\x09< self['@damageRects'].push(aRect); \x0a\x09self['@needsRedraw'] = true; >",
messageSends: [],
referencedClasses: []
}),
...
args: [],
source: "initialize\x0a\x09< self['@needsRedraw'] = false;\x0a\x09self['@damageRects'] = []; >",
messageSends: [],
referencedClasses: []
}),
smalltalk.WorldState);
...
args: [],
source: "initializeRenderLoop\x0a\x09< setInterval(function() {\x0a\x09\x09if (self['@needsRedraw']) {\x0a\x09\x09\x09self['@needsRedraw'] = false;\x0a\x09\x09\x09self['@world']._redrawNow_(self['@damageRects']);\x0a\x09\x09\x09self['@damageRects'] = [];\x0a\x09\x09}\x0a\x09}, 0); >",
messageSends: [],
referencedClasses: []
}),
smalltalk.WorldState);
